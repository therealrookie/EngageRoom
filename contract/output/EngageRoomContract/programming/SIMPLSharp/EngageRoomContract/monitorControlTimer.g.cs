...
{
    public interface ImonitorControlTimer
    {
        ...
        void mondayFb(monitorControlTimerBoolInputSigDelegate callback);
        void tuesdayFb(monitorControlTimerBoolInputSigDelegate callback);
        void wednesdayFb(monitorControlTimerBoolInputSigDelegate callback);
        void thursdayFb(monitorControlTimerBoolInputSigDelegate callback);
        void fridayFb(monitorControlTimerBoolInputSigDelegate callback);
        void saturdayFb(monitorControlTimerBoolInputSigDelegate callback);
        void sundayFb(monitorControlTimerBoolInputSigDelegate callback);
        void signageFb(monitorControlTimerBoolInputSigDelegate callback);
        void tvPlayerFb(monitorControlTimerBoolInputSigDelegate callback);
        void laptopInputFb(monitorControlTimerBoolInputSigDelegate callback);
        void startupWdFb(monitorControlTimerStringInputSigDelegate callback);
        void shutdownWdFb(monitorControlTimerStringInputSigDelegate callback);
        void startupWeFb(monitorControlTimerStringInputSigDelegate callback);
        void shutdownWeFb(monitorControlTimerStringInputSigDelegate callback);

    }

    public delegate void monitorControlTimerBoolInputSigDelegate(BoolInputSig boolInputSig, ImonitorControlTimer monitorControlTimer);
    public delegate void monitorControlTimerStringInputSigDelegate(StringInputSig stringInputSig, ImonitorControlTimer monitorControlTimer);

    internal class monitorControlTimer : ImonitorControlTimer, IDisposable
    {
        ...
        internal monitorControlTimer(ComponentMediator componentMediator, uint controlJoinId)
        {
        ...
        public void mondayFb(monitorControlTimerBoolInputSigDelegate callback)
        {
        ...
        public void tuesdayFb(monitorControlTimerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void wednesdayFb(monitorControlTimerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void thursdayFb(monitorControlTimerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void fridayFb(monitorControlTimerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void saturdayFb(monitorControlTimerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void sundayFb(monitorControlTimerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void signageFb(monitorControlTimerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void tvPlayerFb(monitorControlTimerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void laptopInputFb(monitorControlTimerBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void startupWdFb(monitorControlTimerStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void shutdownWdFb(monitorControlTimerStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void startupWeFb(monitorControlTimerStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void shutdownWeFb(monitorControlTimerStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "monitorControlTimer", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
