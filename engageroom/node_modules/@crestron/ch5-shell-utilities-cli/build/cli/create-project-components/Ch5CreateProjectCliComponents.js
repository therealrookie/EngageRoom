...
exports.Ch5CreateProjectCliCustom = void 0;
...
var Ch5CreateProjectCliCustom = /** @class */ (function (_super) {
    __extends(Ch5CreateProjectCliCustom, _super);
    /**
     * Constructor
     */
    function Ch5CreateProjectCliCustom(showOutputMessages) {
        if (showOutputMessages === void 0) { showOutputMessages = true; }
        var _this = _super.call(this, "create-project-components") || this;
     ...
     * Initialize process
     */
    Ch5CreateProjectCliCustom.prototype.initialize = function () {
     ...
     */
    Ch5CreateProjectCliCustom.prototype.verifyInputParams = function () {
        return __awaiter(this, void 0, void 0, function () {
            var value, inputUpdate, tabDisplayText, warningMessage, i;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                if (this.inputArgs["config"].argsValue !== "") {
                    ...
                    if (this.outputResponse.data.updateInputs.length === 0) {
                        value = this.inputArgs["projectName"];
                        inputUpdate = __assign(__assign({}, value), { "warning": "" });
     ...
     */
    Ch5CreateProjectCliCustom.prototype.checkPromptQuestions = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.inputArgs["config"].argsValue !== "")) return [3 /*break*/, 1];
                        return [3 /*break*/, 5];
                    case 1:
                        this.logger.log("this.outputResponse.data.updateInputs", this.outputResponse.data.updateInputs);
                        _loop_1 = function (i) {
                            var choicesList, componentsQuery, _b, questionsArray, response;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        if (!!this_1.utils.isValidInput(this_1.outputResponse.data.updateInputs[i].argsValue)) return [3 /*break*/, 4];
                                        if (!(this_1.outputResponse.data.updateInputs[i].type === "enum")) return [3 /*break*/, 2];
                                        choicesList = this_1.outputResponse.data.updateInputs[i].allowedValues;
                                        componentsQuery = new this_1.getSelect({
                                            name: 'value',
                                            message: this_1.getText(this_1.outputResponse.data.updateInputs[i].question),
                                            choices: choicesList
                                        });
                                    ...
                                    case 2:
                                        ...
                                        questionsArray = [
                                            {
                                                ...
                                                validate: function (inputValue) {
                                                    var valResponse = _this.validateCLIInputArgument(_this.outputResponse.data.updateInputs[i], _this.outputResponse.data.updateInputs[i]["key"], inputValue, _this.getText("VERIFY_INPUT_PARAMS.INVALID_INPUT", _this.outputResponse.data.updateInputs[i]["key"]));
                                        ...
                                        return [4 /*yield*/, this_1.getEnquirer.prompt(questionsArray)];
                                    case 3:
                                        response = _c.sent();
                                        // Note that the prompt will keep asking inputs till it validates the correct value
                                        if (!this_1.utils.isValidInput(response.projectName)) {
                                            throw new Error(this_1.getText("COMMON.SOMETHING_WENT_WRONG"));
                                        }
                                        this_1.outputResponse.data.updateInputs[i].argsValue = response.projectName;
                                        this_1.logger.log(this_1.outputResponse.data.updateInputs[i].key + ": ", this_1.outputResponse.data.updateInputs[i].argsValue);
                                        _c.label = 4;
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(i < this.outputResponse.data.updateInputs.length)) return [3 /*break*/, 5];
     ...
     */
    Ch5CreateProjectCliCustom.prototype.processRequest = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projectFolderPath, newProjectConfigJSON, pathToCreateProject, isFolder, e_1, oldProjectConfigJSON, k, pagesToBeCreated, _loop_2, i, widgetsToBeCreated, _loop_3, i, packageJsonFile, _loop_4, this_2, i, i, genWidget, projectConfigJSON, pathToCreateProject, isFolder, e_2, packageJsonFile, genPage;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.logger.start("processRequest");
                        projectFolderPath = path.resolve(path.join("./"));
                        if (!(this.inputArgs["config"].argsValue !== "")) return [3 /*break*/, 14];
                        newProjectConfigJSON = JSON.parse(this.utils.readFileContentSync(this.inputArgs["config"].argsValue));
                        pathToCreateProject = path.resolve(path.join("./", newProjectConfigJSON.projectName));
                    ...
                    case 4:
                        ...
                        oldProjectConfigJSON = JSON.parse(this.utils.readFileContentSync(path.join(this.SHELL_FOLDER, this.PROJECT_CONFIG_JSON_PATH)));
                        // 1. Project Data
                        ...
                        packageJsonFile = editJsonFile("./package.json");
                        ...
                        _loop_4 = function (i) {
                            var genPage, pageContentData, newContent_1, contentToChange;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        _b.sent();
                                        pageContentData = JSON.parse(JSON.stringify(pagesToBeCreated[i].pageContent));
                                        delete pagesToBeCreated[i].pageContent;
                                        this_2.logger.log("pagesToBeCreated[i]", pagesToBeCreated[i]);
                                        this_2.projectConfig.replacePageNodeInJSON(pagesToBeCreated[i]);
                                        if (!pageContentData) return [3 /*break*/, 3];
                                        newContent_1 = "";
                                        Object.entries(pageContentData).forEach(function (_a) {
                                            var key = _a[0], value = _a[1];
                                            var fileContent = fsExtra.readFileSync(path.join(__dirname, "templates", key + ".template"));
                                            var _loop_5 = function (j) {
                                                var counterForIndex = 0;
                                                var _loop_6 = function (k) {
                                                    var fileContentForEachItem = "";
                                                    Object.entries(value[j].attributes).forEach(function (_a) {
                                                        var keySecond = _a[0], valueSecond = _a[1];
                                                        // TODO - escape quotes
                                                        valueSecond = _this.utils.replaceAll(valueSecond, "{{idx}}", String(counterForIndex));
                                                        counterForIndex++;
                                                        fileContentForEachItem += " " + keySecond + "='" + valueSecond + "'";
                                                    });
                                                    newContent_1 += _this.utils.replaceAll(fileContent, "<%attributes%>", fileContentForEachItem);
                                                };
                                        ...
                                        contentToChange = "<!-- BEGIN::CHANGEAREA - your page html markup goes here -->";
                                        return [4 /*yield*/, this_2.updateFileContent(path.join(pathToCreateProject, "app", "project", "components", "pages", pagesToBeCreated[i].pageName, pagesToBeCreated[i].pageName + ".html"), contentToChange, contentToChange + "\n" + newContent_1)];
                                    case 2:
                                        _b.sent();
                                        _b.label = 3;
                    ...
                    case 11:
                        i++;
                        return [3 /*break*/, 9];
                    case 12: return [4 /*yield*/, this.isConfigFileValid(path.join(pathToCreateProject, this.PROJECT_CONFIG_JSON_PATH), path.join(pathToCreateProject, this.VSCODE_SCHEMA_JSON_PATH))];
                    case 13:
                        ...
                        return [3 /*break*/, 21];
                    case 14:
                        projectConfigJSON = JSON.parse(this.utils.readFileContentSync(path.resolve(path.join(this.SHELL_FOLDER, this.PROJECT_CONFIG_JSON_PATH))));
                        // 1. Project Data
                        projectConfigJSON.projectName = this.outputResponse.data.updateInputs.find(function (objValue) { return objValue.key === "projectName"; }).argsValue;
                        pathToCreateProject = path.resolve(path.join("./", projectConfigJSON.projectName));
                        _a.label = 15;
                    case 15:
                    ...
                    case 19:
                        _a.sent();
                        return [4 /*yield*/, this.isConfigFileValid(path.join(pathToCreateProject, this.PROJECT_CONFIG_JSON_PATH), path.join(pathToCreateProject, this.VSCODE_SCHEMA_JSON_PATH))];
                    case 20:
                        // Step 6: Run validate:project-config
                        if (!(_a.sent())) {
                            throw new Error(this.getText("PROCESS_REQUEST.PROJECT_CONFIG_VALIDATION_FAILED"));
    ...
    Ch5CreateProjectCliCustom.prototype.updateFileContent = function (templateFileCompletePath, stringToReplace, contentToAdd) {
        return __awaiter(this, void 0, void 0, function () {
            var actualContent;
            return __generator(this, function (_a) {
                actualContent = fsExtra.readFileSync(templateFileCompletePath);
                actualContent = this.utils.replaceAll(actualContent, stringToReplace, contentToAdd);
                fsExtra.writeFileSync(templateFileCompletePath, actualContent);
    ...
    return Ch5CreateProjectCliCustom;
}(Ch5BaseClassForCliNew_1.Ch5BaseClassForCliNew));
exports.Ch5CreateProjectCliCustom = Ch5CreateProjectCliCustom;
