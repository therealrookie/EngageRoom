...
var Ch5CliLogger = /** @class */ (function () {
    ...
    Ch5CliLogger.prototype.log = function () {
        ...
        if (this.allowLogging === true && this.logLevel <= exports.LOG_LEVELS.DEBUG) {
            console.log.apply(console, __spreadArray(__spreadArray([this.FOREGROUND_COLORS.Blue], input), [this.FORMATTING.Reset]));
        }
    };
    Ch5CliLogger.prototype.start = function () {
        ...
        if (this.allowLogging === true && this.logLevel <= exports.LOG_LEVELS.DEBUG) {
            console.group.apply(console, __spreadArray(__spreadArray([this.FOREGROUND_COLORS.Blue], input), [this.FORMATTING.Reset]));
        }
    };
    ...
    Ch5CliLogger.prototype.warn = function () {
        ...
        if (this.allowLogging === true && this.logLevel <= exports.LOG_LEVELS.WARN) {
            console.warn.apply(console, __spreadArray(__spreadArray([this.FOREGROUND_COLORS.Yellow], input), [this.FORMATTING.Reset]));
        }
    };
    /**
     *
    ...
    Ch5CliLogger.prototype.error = function () {
        ...
        if (this.allowLogging === true && this.logLevel <= exports.LOG_LEVELS.ERROR) {
            console.error.apply(console, __spreadArray(__spreadArray([this.FOREGROUND_COLORS.Red], input), [this.FORMATTING.Reset]));
        }
    };
    /**
     *
    ...
    Ch5CliLogger.prototype.info = function () {
        ...
        if (this.allowLogging === true && this.logLevel <= exports.LOG_LEVELS.INFO) {
            console.info.apply(console, __spreadArray(__spreadArray([this.FOREGROUND_COLORS.Magenta], input), [this.FORMATTING.Reset]));
        }
    };
    /**
     *
    ...
    Ch5CliLogger.prototype.trace = function () {
        ...
        if (this.allowLogging === true && this.logLevel <= exports.LOG_LEVELS.TRACE) {
            console.trace.apply(console, __spreadArray(__spreadArray([this.FOREGROUND_COLORS.Cyan], input), [this.FORMATTING.Reset]));
        }
    };
    /**
     *
    ...
    Ch5CliLogger.prototype.printSuccess = function () {
        ...
        console.log.apply(console, __spreadArray(__spreadArray([this.FOREGROUND_COLORS.Green], input), [this.FORMATTING.Reset]));
    };
    /**
     *
     * @param  {...any} input
    ...
    Ch5CliLogger.prototype.printWarning = function () {
        ...
        console.log.apply(console, __spreadArray(__spreadArray([this.FOREGROUND_COLORS.Yellow], input), [this.FORMATTING.Reset]));
    };
    /**
     *
     * @param  {...any} input
    ...
    Ch5CliLogger.prototype.printError = function () {
        ...
        console.log.apply(console, __spreadArray(__spreadArray([this.FOREGROUND_COLORS.Red], input), [this.FORMATTING.Reset]));
    };
    /**
     *
     * @param  {...any} input
