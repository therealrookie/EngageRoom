...
exports.Ch5ImportAllCli = void 0;
...
var Ch5ImportAllCli = /** @class */ (function (_super) {
    __extends(Ch5ImportAllCli, _super);
    function Ch5ImportAllCli(showOutputMessages) {
        if (showOutputMessages === void 0) { showOutputMessages = true; }
        var _this = _super.call(this, "import-all") || this;
     ...
     */
    Ch5ImportAllCli.prototype.initialize = function () {
        this.outputResponse = {
            result: false,
            errorMessage: "",
            warningMessage: "",
    ...
    Object.defineProperty(Ch5ImportAllCli.prototype, "getZl", {
        /**
     ...
     */
    Ch5ImportAllCli.prototype.run = function () {
     ...
     */
    Ch5ImportAllCli.prototype.verifyInputParams = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @param {*} fileName
     */
    Ch5ImportAllCli.prototype.isFileToBeAvoided = function (fileName) {
     ...
     * @param {*} input
     */
    Ch5ImportAllCli.prototype.replaceDistFolderPathNameInInput = function (input) {
     ...
     * @param {*} sourcePath
     */
    Ch5ImportAllCli.prototype.getAllFiles = function (sourcePath) {
        var _this = this;
        return fs.readdirSync(sourcePath).reduce(function (files, file) {
            ...
            return isDirectory ? __spreadArray(__spreadArray([], files), _this.getAllFiles(name)) : __spreadArray(__spreadArray([], files), [name]);
        }, []);
    };
    /**
     * Check if there are questions to be prompted to the developer
     */
    Ch5ImportAllCli.prototype.checkPromptQuestions = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    Ch5ImportAllCli.prototype.processRequest = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pagesSelected, widgetsSelected, i, fromPath, toPath, fromPathFile, toPathFile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.inputArguments["all"] === true) {
                            ...
                            for (i = 0; i < this.outputResponse.data.inputFileExistsInSourceFolder.length; i++) {
                                ...
                                if (fromPath.indexOf(path.normalize("components/pages")) >= 0) {
                                    ...
                                    fromPathFile = path.normalize((path.join(this.folderPaths.temporaryLocationForAllFilesCopyFrom, path.normalize(this.outputResponse.data.inputFileExistsInSourceFolder[i]))));
                                    toPathFile = path.normalize((path.normalize(this.outputResponse.data.inputFileExistsInSourceFolder[i])));
                                    fsExtra.copySync(fromPathFile, toPathFile, { recursive: true, overwrite: this.outputResponse.data.overwriteFiles, filter: function (file) { if (path.basename(file).toLowerCase() === "project-config.json") {
                                            return false;
                                        }
                                        else {
                                            return true;
     ...
     */
    Ch5ImportAllCli.prototype.logOutput = function () {
     ...
     * Clean up method
     */
    Ch5ImportAllCli.prototype.cleanUp = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
     ...
     * @param {*} newFile
     */
    Ch5ImportAllCli.prototype.checkIfNewFileInput = function (arrayOfFiles, newFile) {
     ...
     * @param {*} fileName
     */
    Ch5ImportAllCli.prototype.isZipFileValid = function (fileName) {
     ...
     */
    Ch5ImportAllCli.prototype.processExportedProjectConfigJSON = function (selectedPages, selectedWidgets) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return Ch5ImportAllCli;
}(Ch5BaseClassForCli_1.Ch5BaseClassForCli));
exports.Ch5ImportAllCli = Ch5ImportAllCli;
