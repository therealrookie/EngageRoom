...
var Ch5UpgradeProjectCli = /** @class */ (function (_super) {
    ...
    Ch5UpgradeProjectCli.prototype.processDirectoriesOld = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            https.get(v2URL, function (res) {
                ...
                var filePath = fs.createWriteStream(_this.temporaryPath + "/v2.zip");
                res.pipe(filePath);
                filePath.on('finish', function () {
                    // download file to V2.zip
                    filePath.close();
                    // extract v2.zip to v2
                    zl.extract(_this.temporaryPath + "/v2.zip", _this.temporaryPath + "/v2").then(function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            try {
                                this.processCode();
                                resolve(true);
    ...
    Ch5UpgradeProjectCli.prototype.cleanUp = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                setTimeout(function () {
                    _this.utils.deleteFolder(_this.temporaryPath);
                }, 100);
                return [2 /*return*/];
            });
        });
