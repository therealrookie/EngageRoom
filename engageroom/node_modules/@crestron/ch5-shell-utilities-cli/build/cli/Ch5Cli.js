...
var Ch5CreateProjectCliComponents_1 = require("./create-project-components/Ch5CreateProjectCliComponents");
...
var Ch5ShellCli = /** @class */ (function () {
    function Ch5ShellCli() {
        ...
        this.createProjectCustom = new Ch5CreateProjectCliComponents_1.Ch5CreateProjectCliCustom();
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        program
                            ...
                            .addHelpText('after', "\n  Ch5 Shell CLI Version: " + buildVersion + "\n  Minimum node version required for CLI: v" + this.createProject.configFileReader.configFile.settings.minimumNodeVersion + "\n  Minimum npm version required for CLI: v" + this.createProject.configFileReader.configFile.settings.minimumNPMVersion + "\n      ");
                    ...
                    case 1:
                        ...
                        // );
                        _a.sent();
                        return [4 /*yield*/, this.createProjectCustom.setupCommand(program)];
                    case 2:
                        _a.sent();
